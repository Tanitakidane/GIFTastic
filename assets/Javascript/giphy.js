var topics = ["Goku", "Vegeta", "Trunks", "Frieza", "Jiren",
"Piccolo", "Goten", "Android 17", "Android 18", "Master Roshi",
"Tien", "Majin Buu", "Beerus", "Caulifla", "Broly",
"Bulma", "Krillin", "Chi-Chi"];
var numberOfGIFs = 10;
var cutOffRating = "PG";
...
function populateGIFContainer(show){
	$.ajax({
		...
		"&api_key=IrN1TydDWP0QeCV8ig0eu5CzDMBtsNgE&rating=" + cutOffRating + "&limit=" + numberOfGIFs,
		method: "GET"
